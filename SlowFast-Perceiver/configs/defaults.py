...
#
_C.PERCEIVER.FREQ_BASE = 2

#
_C.PERCEIVER.INPUT_CHANNELS = 3

#
_C.PERCEIVER.INPUT_AXIS = 2

#
_C.PERCEIVER.NUM_LATENTS = 512

#
_C.PERCEIVER.LATENT_DIM = 512
...
#
_C.PERCEIVER.NUM_CLASSES = 16

#
_C.PERCEIVER.ATTN_DROPOUT = 0.

#
_C.PERCEIVER.FF_DROPOUT = 0.

#
_C.PERCEIVER.WEIGHT_TIE_LAYERS = False

#
_C.PERCEIVER.FOURIER_ENCODE_DATA = True

#
_C.PERCEIVER.SELF_PER_CROSS_ATTN = 1

#
_C.PERCEIVER.SELF_ATTN_REL_POS = True
...
#
_C.VIVIT.PATCH_SIZE = 32
_C.VIVIT.DIM = 128
_C.VIVIT.DEPTH = 6
_C.VIVIT.HEADS = 64
_C.VIVIT.MLP_DIM = 2048
_C.VIVIT.DIM_HEAD = 128
