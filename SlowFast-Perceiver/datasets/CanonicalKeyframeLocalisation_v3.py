...
class CanonicalKeyframeLocalisation_v2(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.mode == "test":
            if info['unique_id'] in ['a28bfe2e-5b84-467c-a8e5-fafecdfee51d',
                                     '97eda02f-513b-4c42-a347-6b59bf8badd8',
                                     'f8aed99f-ee06-43e6-bbd8-1b368520883b',
                                     '3802b834-c6d6-41b2-9914-71abbcb793d0',
                                     '200a4f7b-e582-424c-8c89-70d1412fe4f9',
                                     '11e217e4-8e68-48d1-b7ce-db53df46791a',
                                     '46337ca4-7410-41a4-9e39-134bfee21af4',
                                     '7a90f145-ad23-4cdb-907d-1b6e862fefd8',
                                     'a6f65c6a-5a5d-4038-bbd0-13ce5a803653',
                                     '128ee09d-6121-4663-b4c1-f40c3e9386d0']:
