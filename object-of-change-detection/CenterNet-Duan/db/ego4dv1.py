...
class Ego4dv1(DETECTION):
    def __init__(self, db_config, split):
        super(Ego4dv1, self).__init__(db_config)
        ...
        self._coco_dir = os.path.join(data_dir, "ego4dv1")

        self._label_dir = os.path.join(self._coco_dir, "coco_annotations")
        self._label_file = os.path.join(self._label_dir, "{}.json")
        self._label_file = self._label_file.format(self._dataset)

        self._image_dir = os.path.join(self._coco_dir, "pre_pnr_post_frames")
        ...
        self._cache_file = os.path.join(cache_dir, "Ego4dv1_{}.pkl".format(self._dataset))
        self._load_data()
