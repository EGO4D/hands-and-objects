...
class BMN(nn.Module):
    def __init__(self):
        ...
        self.tscale = 16 #opt["temporal_scale"]
        self.prop_boundary_ratio = 0.5 #opt["prop_boundary_ratio"]
        self.num_sample = 32 #opt["num_sample"]
        self.num_sample_perbin = 3 #opt["num_sample_perbin"]
        self.feat_dim= 131072 #opt["feat_dim"]
